...
import com.agencia.dao.PacoteViagemDAO;
import com.agencia.dao.ServicoAdicionalDAO;
...
public class Main {
    public static void main(String[] args) {
        ...
        String[] opcoesMenuPrincipal = {"Gerenciar Clientes", "Gerenciar Pacotes de Viagem", "Gerenciar Serviços Adicionais", "Sair"};
        while (true) {
            ...
            if (escolha == 0) {
                ...
                menuPacotes(pacoteDAO);
            } else if (escolha == 2) {
                menuServicos(servicoDAO);
            } else {
                break;
            }
        }
